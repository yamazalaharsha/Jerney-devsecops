...
2.  **Create a `terraform.tfvars` file:**
    This file will contain your project-specific variables. A `terraform.tfvars.example` is provided in the `terraform` directory.
    ```terraform
...
| Branch | Purpose |
|--------|---------|
| `main` | Source code + GCP DevSecOps Deployment |
| `devsecops` | Development branch for DevSecOps features |
